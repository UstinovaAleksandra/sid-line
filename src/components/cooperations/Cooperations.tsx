		...
		<div className='cooperations' id='coop'>
			<div className='cooperations__areas'>
				...
				<div className='areas__text'>
					ТК "sid-line" осуществляет поставки импортного промышленного оборудования для производственных предприятий
					...
					комплектующих, ТК "sid-line" готова решить задачу поиска, закупки и поставки оборудования практически для
